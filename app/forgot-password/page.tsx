            ...
            <div id="content" className="flex flex-col z-50 relative max-w-screen">
                ...
                sm:-top-20 border border-[#00977F]">
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => { handleChange(e); validateEmail(e); }}
                            onBlur={(e: React.ChangeEvent<HTMLInputElement>) => { handleChange(e); validateEmail(e); }}
                        />
