...
export default function Home() {
  ...
  const controlFormDataChanges = (e: Event) => {
    ...
    <main className="bg-green-50 max-w-screen relative text-[#575A65] sm:overflow-hidden">
      ...
      <div id="content" className="flex flex-col z-50 relative max-w-screen">
        ...
        <div id="login" className="self-center rounded-md bg-white p-4 mx-4 sm:p-16 sm:mx-0 py-8 sm:py-10 flex flex-col gap-5 relative -top-16 border border-[#00977F]">
          ...
          onChange={(e:any) => {controlFormDataChanges(e); verifyEmail(e)}} onBlur={(e:any) => verifyEmail(e)} ref={emailRef}/>
          ...
          onChange={(e:any) => {controlFormDataChanges(e); verifyPassword(e)}} onBlur={(e:any) => verifyPassword(e)} ref={passwordRef}/>
          ...
          <div id="remember-me" className="flex justify-between text-[15px]">
            <div className="flex gap-2">
              <CustomCheckbox updateCheckedState = {(checked: boolean) => updateFormData((prevState) => ({...prevState, isChecked: !checked}))}/>
          ...
          disabled:opacity-50 hover:bg-[#007965]" onClick={(e:any) => handleFormSubmission(e)}>{loginLoading ? Spinner: "Log In"}</button>
