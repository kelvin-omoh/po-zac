...
import Modal from '../component/Modal'; // Assume you have a modal component
...
const positiveAcronyms: AcronymQuestion[] = [
    {
        acronym: "SMART",
        options: [
...
const GamePage: React.FC = () => {
    ...
    const handleOptionClick = (event: React.MouseEvent<HTMLButtonElement>, option: string) => {
