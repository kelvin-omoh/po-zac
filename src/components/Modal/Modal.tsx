...
const Modal = (props: {show: boolean, children: any, blur: boolean}) => {
    return (
        ...
        ${props.blur? "bg-[rgba(0, 0, 0, 0.4)] backdrop-blur-[15px]": "bg-blue-950 backdrop-blur-[15px]"} cursor-pointer`}>
            <div id="modal-content" className='bg-[url("/game/wood-bg.jpg")] rounded-2xl mx-4 sm:mx-0 sm:p-8 cursor-default'>
                {props.children}
            </div>
        </div>
    );
